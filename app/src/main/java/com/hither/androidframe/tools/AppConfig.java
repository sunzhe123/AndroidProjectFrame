...
public class AppConfig {
    ...
    public AppConfig() {
        MyApplication delegate = MyApplication.getInstance();
    ...
    public static String getUUID() {
        final TelephonyManager tm = (TelephonyManager) MyApplication.getInstance()
                .getSystemService(Context.TELEPHONY_SERVICE);
        final String tmDevice, tmSerial, androidId;
        tmDevice = "" + tm.getDeviceId();
        tmSerial = "" + tm.getSimSerialNumber();
    ...
    public static int getStatusHeight() {
        ...
        try {
            ...
            int height = Integer.parseInt(clazz.getField("status_bar_height")
                    .get(object).toString());
            statusHeight = MyApplication.getInstance().getResources().getDimensionPixelSize(height);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return statusHeight;
    ...
    public static String getAppPackage(Context context) {
        ...
        return info.packageName;// 得到现在app的包名
    }
}
